import type { LayerId, TerrainNode, ViewportState } from "@seekstar/core-schema";
...
export function worldToScreen(point: CanvasPoint, viewport: ViewportState, bounds: DOMRect): CanvasPoint {
  return {
